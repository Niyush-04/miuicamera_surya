...
.method private showCoverView(Landroid/graphics/Bitmap;)V
    ...
    invoke-direct {v1, p0, v0, p1}, LOooO0O0/OooO0O0/OooO00o/OooO0O0;-><init>(Lcom/android/camera/ActivityBase;Landroid/graphics/Rect;Landroid/graphics/Bitmap;)V
...
.method public abstract create2OpenCamera()V
.end method
...
.method public destroyActivity()V
    ...
    .line 3
    invoke-virtual {v0, v1}, Lcom/android/camera/ui/RenderEngineAdapter;->getAnimationResult(I)Ljava/lang/Object;
...
.method public declared-synchronized hasSurface()Z
    ...
    invoke-direct {v1, p0}, LOooO0O0/OooO0O0/OooO00o/OooO00o;-><init>(Lcom/android/camera/ActivityBase;)V
...
.method public isShowBottomIntentDone()Z
    ...
    const-class v0, Lcom/android/camera/protocol/protocols/BaseDelegate;
    ...
    check-cast p0, Lcom/android/camera/protocol/protocols/BaseDelegate;
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    .line 2
    invoke-virtual {p0}, Lcom/android/camera/ActivityBase;->create2OpenCamera()V
...
.method public onFrameAvailable(I)V
    ...
    const-string/jumbo v0, "startPreview2firstFrame"
    ...
    iget-wide v8, p0, Lcom/android/camera/ActivityBase;->mAppStartTime:J
    ...
    sget-object v11, Lcom/android/camera/performance/Action$Event;->COLD_LAUNCH:Lcom/android/camera/performance/Action$Event;
    ...
    invoke-virtual {v8, v10}, Lcom/android/camera/performance/PerformanceManager;->resetActionInfo([Ljava/lang/Object;)V
    ...
    new-array v9, v9, [Lcom/android/camera/performance/Action$Event;
    ...
    sget-object v10, Lcom/android/camera/performance/Action$Event;->HOT_LAUNCH:Lcom/android/camera/performance/Action$Event;

    aput-object v10, v9, v4

    invoke-virtual {v8, v9}, Lcom/android/camera/performance/PerformanceManager;->stopEvent([Lcom/android/camera/performance/Action$Event;)J

    .line 5
    invoke-static {v6, v7}, Lcom/android/camera/statistic/CameraStatUtils;->trackStartAppCost(J)V
    ...
    invoke-virtual {v8}, Lcom/android/camera/performance/PerformanceManager;->isProfilingStartPreview()Z
    ...
    invoke-virtual {v8, v0}, Lcom/android/camera/performance/PerformanceManager;->endAction(Ljava/lang/String;)J
    ...
    invoke-virtual {v0, v5}, Lcom/android/camera/performance/PerformanceManager;->setProfilingStartPreview(Z)V
    ...
    .line 16
    iget-wide v8, p0, Lcom/android/camera/ActivityBase;->mModeSwitchTime:J
    ...
    const-string/jumbo v11, "onFrameAvailable: trackModeSwitchCost: "
    ...
    .line 18
    invoke-static {v6, v7}, Lcom/android/camera/statistic/CameraStatUtils;->trackSwitchModeCost(J)V
    ...
    sget-object v8, Lcom/android/camera/performance/Action$Event;->SWITCH_MODULE:Lcom/android/camera/performance/Action$Event;

    aput-object v8, v7, v5

    invoke-virtual {v6, v7}, Lcom/android/camera/performance/PerformanceManager;->resetActionInfo([Ljava/lang/Object;)V
    ...
    new-array v7, v4, [Lcom/android/camera/performance/Action$Event;
    ...
    invoke-virtual {v6}, Lcom/android/camera/performance/PerformanceManager;->isProfilingStartPreview()Z
    ...
    invoke-virtual {v6, v0}, Lcom/android/camera/performance/PerformanceManager;->endAction(Ljava/lang/String;)J
    ...
    .line 27
    invoke-static {v6, v7}, Lcom/android/camera/statistic/CameraStatUtils;->trackSwitchCameraCost(J)V
...
.method public showBlurCover()V
    ...
    .line 8
    invoke-virtual {v3, v2}, Lcom/android/camera/ui/RenderEngineAdapter;->getAnimationResult(I)Ljava/lang/Object;
    ...
    .line 11
    invoke-direct {p0, v2}, Lcom/android/camera/ActivityBase;->showCoverView(Landroid/graphics/Bitmap;)V
