...
.method public accept(Lcom/android/camera/module/loader/NullHolder;)V
    ...
    invoke-static {p1, v2}, Lcom/android/camera/Camera;->access$202(Lcom/android/camera/Camera;Lio/reactivex/disposables/Disposable;)Lio/reactivex/disposables/Disposable;
    ...
    .line 19
    invoke-virtual {p1, v0}, Lcom/android/camera/protocol/ModeCoordinatorImpl;->getAttachProtocol(Ljava/lang/Class;)Lcom/android/camera/protocol/BaseProtocol;

    move-result-object p1

    check-cast p1, Lcom/android/camera/protocol/protocols/MultiFeatureManager;
    ...
    invoke-interface {v2, v0}, Lcom/android/camera2/compat/theme/common/MiThemeOperationTabIf;->getPopupMenuDragListener(Lcom/android/camera/ui/PopupMenuLayout;)Lcom/android/camera/ui/DragLayout$OnDragListener;

    move-result-object v0

    invoke-interface {p1, v0}, Lcom/android/camera/protocol/protocols/MoreModePopupController;->addOnDragListener(Lcom/android/camera/ui/DragLayout$OnDragListener;)V
